...
- LC لا يطلب أو يجمع كلمات مرور المستخدمين، وروابط userinfo لا تُرسل للتحقق الخارجي.
...
- تقييد مصادر CORS المسموح بها للواجهة المنشورة وبيئات الاختبار المحلية.
- حدود طلبات بسيطة على نقاط Backend لتقليل إساءة استخدام مفتاح الخدمة.
